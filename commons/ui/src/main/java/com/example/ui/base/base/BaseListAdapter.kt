...
package com.example.ui.base.base
...
import com.example.ui.base.BaseModel
 ...
 * @see ListAdapter
 */
abstract class BaseListAdapter<T:BaseModel>: ListAdapter<T, RecyclerView.ViewHolder>(object : DiffUtil.ItemCallback<T>() {
